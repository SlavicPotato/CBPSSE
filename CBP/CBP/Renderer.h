...
namespace CBP
{
    ...
    private:
        static inline constexpr std::uint32_t NB_SECTORS_SPHERE = 9;
        static inline constexpr std::uint32_t NB_STACKS_SPHERE = 5;
        ...
        void __vectorcall GenerateSphere(const btVector3& a_pos, float a_radius, const DirectX::XMVECTOR a_col);
        ...
        SKMP_FORCEINLINE bool __vectorcall IsValidPosition(const DirectX::XMVECTOR a_pos);
        ...
        SKMP_FORCEINLINE void __vectorcall drawLine(const btVector3& from, const btVector3& to, const DirectX::XMVECTOR color);
        void __vectorcall drawBox(const btVector3& bbMin, const btVector3& bbMax, const Bullet::btTransformEx& trans, const DirectX::XMVECTOR color);
